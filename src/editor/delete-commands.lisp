...
#|
 ...
 (loop as x in (coerce (slot-value *command-names* 'table) 'list) 
       when x 
       collect (slot-value x 'proper))

|#


(defvar *deleted-commands* 
  ;;; Date: 2010-05-04
  '(; "Abbrev Expand Only"
    ; "Abbrev Mode"
    ...
    ;;; NICHT Loeschen! Echo Area Return! 
    ; "Confirm Parse" 
...
(mapcar #'delete-command *deleted-commands*)
